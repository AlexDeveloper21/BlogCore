...
namespace Proyecto2.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            //Campos personalizados que tienen que ser los mismos que los de ApplicationUser
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Validamos si los roles existen y sino se crean
                    ...
                    //Validamos si el rol seleccionado es Admin y si no lo es lo agregamos
